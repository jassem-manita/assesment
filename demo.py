...
def main():
    ...
    # Initialize session state for model and n_periods
    ...
    st.session_state.selected_model = st.selectbox(
        ...
        ['arima', 'prophet', 'xgboost', 'random_forest'], 
        index=['arima', 'prophet', 'xgboost', 'random_forest'].index(st.session_state.selected_model)
    )
    ...
    if st.button("Compare All Models"):
        comparison_results = {}
        for model in ['arima', 'prophet', 'xgboost', 'random_forest']:
